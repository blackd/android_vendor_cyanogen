...
# Extra leo overlay
PRODUCT_PACKAGE_OVERLAYS += vendor/pffmod/overlay/leo

# This file is used to install the enable RMNET and corresponding modules which dont get activated by normal module script
PRODUCT_COPY_FILES += \
    vendor/pffmod/prebuilt/leo/etc/init.d/01modules:system/etc/init.d/01modules \
...
ifdef CYANOGEN_NIGHTLY
    PRODUCT_PROPERTY_OVERRIDES += \
        ro.modversion=pffmod-7-$(shell date +%m%d%Y)-NIGHTLY-LEO
else
    ifdef CYANOGEN_RELEASE
        PRODUCT_PROPERTY_OVERRIDES += \
            ro.modversion=pffmod-7.1.0-RC0-LEO
    else
        PRODUCT_PROPERTY_OVERRIDES += \
            ro.modversion=pffmod-7.1.0-RC0-LEO-KANG
    endif
endif
