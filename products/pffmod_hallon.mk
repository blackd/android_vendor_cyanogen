...
PRODUCT_PACKAGE_OVERLAYS += vendor/pffmod/overlay/hallon
...
ifdef CYANOGEN_NIGHTLY
    PRODUCT_PROPERTY_OVERRIDES += \
        ro.modversion=pffmod-7-$(shell date +%m%d%Y)-NIGHTLY-XperiaNeo-MT15i
else
    ifdef CYANOGEN_RELEASE
        PRODUCT_PROPERTY_OVERRIDES += \
            ro.modversion=pffmod-7.1.0-XperiaNeo-MT15i
    else
        PRODUCT_PROPERTY_OVERRIDES += \
            ro.modversion=pffmod-7.1.0-XperiaNeo-MT15i-KANG
    endif
endif
