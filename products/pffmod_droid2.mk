...
ifdef CYANOGEN_NIGHTLY
    PRODUCT_PROPERTY_OVERRIDES += \
        ro.modversion=pffmod-7.1-$(shell date +%m%d%Y)-NIGHTLY-DROID2
else
    ifdef CYANOGEN_RELEASE
        PRODUCT_PROPERTY_OVERRIDES += \
            ro.modversion=pffmod-7.1.0-RC0-DROID2
    else
        PRODUCT_PROPERTY_OVERRIDES += \
            ro.modversion=pffmod-7.1.0-RC0-DROID2-KANG
    endif
endif
...
PRODUCT_PACKAGE_OVERLAYS += vendor/pffmod/overlay/droid2
